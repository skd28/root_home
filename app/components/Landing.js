        ...
        {/* <div className=" bg-black  grid grid-cols-2   ">
          <div className="  my-20 relative left-14">
            ...
            <div className="text-white w-2/3 text-3xl mt-5 ">
              At Root, we innovate advanced security networks and develop
              products tailored for the next generation.
            </div>
          </div>
          <div>
            <Lotiee
              ...
              <div className="mt-4">
                {activeTab === "tab1" && (
                  <div className="  bg-fixed ">
                    ...
                    <div className="w-fit  pt-4 text-white text-base font-normal font-inter my-2 ">
                      ...
                      essential. We get only your issues and start planning on
                      it
                    </div>
                  </div>
                )}
                {activeTab === "tab2" && (
                  <div className=" bg-fixed w-full h-1/2 ">
                    ...
                    <div className="w-fit h-1/4 pt-4 text-white text-base font-normal font-inter my-2 ">
                      We plan carefully for our clients, focusing on their
                      needs. Our goal is clear: allocate resources wisely to
                      achieve the best results for optimal satisfaction.
                    </div>
                  </div>
                )}
                {activeTab === "tab3" && (
                  <div className="  bg-fixed w-full h-1/2 ">
                    ...
                    <div className="w-fit h-1/4 pt-4 text-white text-base font-normal font-inter my-2">
                      We craft idea samples for clients before the final
                      product, allowing us to refine and visualize concepts.
                      This ensures the end result meets expectations and
                      requirements effectively for client satisfaction.
                    </div>
                  </div>
                )}
                {activeTab === "tab4" && (
                ...
                {activeTab === "tab5" && (
                  <div className="  bg-fixed w-full h-1/2 ">
                    ...
                    <div className="w-fit h-1/4 pt-4 text-white text-base font-normal font-inter  ">
                      ...
                      finalizing any task, ensuring that everything meets our
                      high standards. We're dedicated to completing requirements
                ...
                {activeTab === "tab6" && (
                  <div className="  bg-fixed w-full h-1/2 ">
                    ...
                    <div className="w-fit h-1/4 pt-4 text-white text-base font-normal font-inter my-2">
                      We ensure the smooth progress of the project by
                      maintaining a thorough understanding of every aspect.
                    </div>
                  </div>
                )}
              </div>
                ...
                {activeTab === "tab1" && (
                  <div className=" h-fit ">
                    <div className=" text-white text-sm font-normal font-inter w-full text-center lg:w-[92%] mb-4">
                      ...
                      by following industry best practices, implementing
                  ...
                  <div>
                    <div className=" h-fit ">
                      <div className=" text-white text-sm font-normal font-inter  w-[92%] mb-4">
                        Our IT Audit services provide an independent and
                        objective review of (Tinfrastructure, control
                        configuration. and regulatory compliance through
                        in-depthtesting and expert analysis. We propose
                        implementation of appropriate security measures. During
                        a functionalaudit we examine whether the company's IT
                        systems operate according to predefined business logic
                        and identify areas which do not comply with either
                        efficiency or business requirements.
                      </div>
                ...
                {activeTab === "tab3" && (
                  <div className=" h-fit ">
                    <div className=" text-white text-sm font-normal font-inter  w-[92%] mb-4">
                      ...
                      services and solutions, advisory, design, implementation
                      and operations management for business of any size. Our
                      Cloud Services support various requirements and are
                      delivered securely. Though we provide cloud services from
                      our own cloud data center, we have knowledge and expertise
                      to monitor & manage cloud of any services like, Microsoft
                      Azure, AWS, etc.
                    </div>
                    <div className="grid grid-cols-3 gap-14  h-fit">
                      <div className="  col-span-2 h-[30rem] ">
                ...
                {activeTab === "tab4" && (
                  <div className=" h-fit ">
                    <div className=" text-white text-sm font-normal font-inter  w-[92%] mb-4">
                      ...
                      possesses comprehensive knowledge across all SEO
                      approaches. Whether it's on-page optimization, off-page
                      strategies, technical SEO, or local SEO,
                    </div>
                    <div className="grid grid-cols-3 gap-14  h-fit">
                      <div className="  col-span-2 h-[30rem] ">
                        <div className=" text-white text-4xl font-bold font-inter my-5">
                ...
                {activeTab === "tab5" && (
                  <div className=" h-fit ">
                    <div className=" text-white text-sm font-normal font-inter  w-[92%] mb-4">
                      ...
                      software development and operations. By harnessing the
                      power of DevOps as a Service, you can accelerate your
                      projects, enhance collaboration, and stay ahead in the
                      rapidly evolving tech landscape. Hustle faster, innovate
                      better, and achieve your business goals with ease.
                    </div>
                    <div className="grid grid-cols-3 gap-14  h-fit">
                      <div className="  col-span-2 h-[30rem] ">
                        <div className=" text-white text-4xl font-bold font-inter my-5">
                ...
                {activeTab === "tab6" && (
                  <div className=" h-fit ">
                    <div className=" text-white text-sm font-normal font-inter  w-[92%] mb-4">
                      ...
                      seamlessly adapts to mobile devices. Our approach to
                      website design combines strategic brand thinking with
                      creative innovation and the latest trends in user
                      interface, resulting in visually stunning websites that
                ...
                {activeTab === "tab7" && (
                  <div className=" h-fit ">
                    <div className=" text-white text-sm font-normal font-inter  w-[92%] mb-4">
                      ...
                      budgeted, reliable managed hosting services to keep
          ...
          <div className=" grid grid-cols-2  ">
            <div className=" px-10">
              ...
              <div className="w-3/5 h-1/4 pt-3 text-white text-2xl font-normal font-inter ">
                Here are some blogs which will help you in implementing
                practices not just for big, but any clientele you have.
              </div>
            </div>
            <div>
              ...
              {activeTab === "tab1" && (
                <div>
                  <div className="grid grid-flow-col">
                    ...
                    <div className="w-52 h-full text-white text-xl font-bold font-inter pr-5">
                      308-308A Mint Chambers, 45/47 Mint Road, Mumbai 400001
                      INDIA
                    </div>
                  </div>
