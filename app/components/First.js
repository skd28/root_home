...
function First() {
    ...
    return (
        <>
            <div className="h-screen bg-blue-50   bg-fixed sm:bg-cover sm:bg-center bg-[url('/mobile.jpg')] md:bg-[url('/Desktop.jpg')] overflow-y-auto" >
                {/* Logo */}
                ...
                <div className=' w-full  pt-8  md:grid md:grid-cols-2 ' >
                    ...
                    <p className='text-white text-center text-xs xs:pt-12 sm:pt-48   '>Copyrights @ Root Integrated Technologies Pvt. Ltd 2023</p>
                </div>
            </div >
        </>
    )
