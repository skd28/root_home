      ...
      <div className=" sm:h-screen  bg-blue-50   bg-fixed sm:bg-cover sm:bg-center bg-[url('/mobile.jpg')] md:bg-[url('/Desktop.jpg')]">
        ...
        <div className=" w-full  pt-8  md:grid md:grid-cols-2 ">
          ...
          <div className=" mx-auto md:mx-0 md:px-7 lg:px-16 sm:text-center  xs:text-center md:text-left text-center ">
            <h1 className="text-white text-[2rem] font-semibold xs:text-[3rem] sm:text-[5rem] md:text-[4rem] lg:text-[4rem]">
              Get ready for
            </h1>
            <h1 className="text-white text-[2rem] font-semibold bottom-4 relative xs:text-[3rem] sm:text-[5rem] md:text-[4rem] lg:text-[4rem]">
              your
            </h1>

            <h1 className="text-[#61ABEB] text-[2rem] font-semibold bottom-5 relative xs:text-[3rem] sm:text-[5rem] md:text-[4rem] lg:text-[4rem]">
              {" "}
              technological
            </h1>
            <h1 className="text-[#61ABEB] text-[2rem] font-semibold bottom-5 relative xs:text-[3rem] sm:text-[5rem] md:text-[4rem] lg:text-[4rem]">
            ...
            {!finish && (
              <p className="text-white bottom-5 relative ">
                We are halfway....
              </p>
            )}
          </div>
            ...
            <div className="text-center items-center justify-center relative grid grid-rows-2 mx-auto md:mx-0 ">
              <div className="grid grid-cols-2 gap-20  md:gap-10 ">
                <div>
                  ...
                  <p className="text-white text-[1rem] w-3/5  bottom-4 relative  mx-auto ">
                    Days
                  </p>
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-20 md:gap-10 ">
                <div>
                  ...
                  <p className="text-white text-[1rem] w-3/4  bottom-4 relative mx-auto ">
                    Minutes
                  </p>
                </div>
                <div>
          ...
          {finish && (
            <div className="w-60 h-96 xs:w-72  bg-sky-400 border-2 mt-10 mb-5 mx-auto sm:mt-10 sm:mb-2 sm:w-80 sm:h-96 md:w-72 md:relative md:left-10 md:mt-10 lg:relative lg:left-0 lg:h-96 lg:w-96 lg:mt-8 ">
              <div
                class="text-center text-white text-5xl xs:text-6xl mt-16 font-bold font-inter cursor-pointer"
              ...
              <Lotiee
                animationData={lot}
                className="w-48 h-44 mx-auto mt-10"
              ></Lotiee>
        ...
        <div className="pb-4 h-1/4">
          <p className="text-white text-center text-xs xs:pt-4 sm:pt-20 lg:pt-96">
